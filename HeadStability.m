...
hybridMod = 4; % number of modules after 4th having dual function
...
%     gait_angles = getSlitherAng(t,gaitMod);
    gait_angles = getSidewind(t,gaitMod);
...
goal_angles = IKf(target,baseIK,T_base,gait_angles(gaitMod-hybridMod+1:gaitMod...
        ),options,ang_cost,pos_cost,dir_cost,hybridMod);
